...
| `gors/src/compiler/item_reachability.rs` external trait impl reachability | `crate::fmt::Stringer` impls require explicit trait reachability instead of self reachability | stdlib workaround | Replace with semantic trait-impl reachability that can distinguish unused formatting helper impls from required generated interface conversions for builtin errors and local package interfaces. |
