...
| Method arg coercion | method names `Write`, `argNumber`, `printArg`, `printValue` | stdlib workaround | Coerce method arguments using resolved receiver type plus method signature, including ownership requirements for interface values and mutable buffers. |
