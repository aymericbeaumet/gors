...
pub fn must_error_files() -> &'static HashSet<&'static str> {
    ...
    MUST_ERROR_FILES.get_or_init(|| {
        ...
        for file in [
            "fixtures/repositories/go/test/bombad.go",
            "fixtures/repositories/go/test/char_lit1.go",
            "fixtures/repositories/go/test/const2.go",
            "fixtures/repositories/go/test/switch2.go",
            "fixtures/repositories/go/test/fixedbugs/bug014.go",
            "fixtures/repositories/go/test/fixedbugs/bug050.go",
            "fixtures/repositories/go/test/fixedbugs/bug068.go",
            "fixtures/repositories/go/test/fixedbugs/bug088.go",
            "fixtures/repositories/go/test/fixedbugs/bug106.go",
            "fixtures/repositories/go/test/fixedbugs/bug121.go",
            "fixtures/repositories/go/test/fixedbugs/bug163.go",
            "fixtures/repositories/go/test/fixedbugs/bug169.go",
            "fixtures/repositories/go/test/fixedbugs/bug222.go",
            "fixtures/repositories/go/test/fixedbugs/bug228.go",
            "fixtures/repositories/go/test/fixedbugs/bug228a.go",
            "fixtures/repositories/go/test/fixedbugs/bug274.go",
            "fixtures/repositories/go/test/fixedbugs/bug280.go",
            "fixtures/repositories/go/test/fixedbugs/bug282.go",
            "fixtures/repositories/go/test/fixedbugs/bug287.go",
            "fixtures/repositories/go/test/fixedbugs/bug298.go",
            "fixtures/repositories/go/test/fixedbugs/issue11359.go",
            "fixtures/repositories/go/test/fixedbugs/issue11610.go",
            "fixtures/repositories/go/test/fixedbugs/issue15611.go",
            "fixtures/repositories/go/test/fixedbugs/issue23587.go",
            "fixtures/repositories/go/test/fixedbugs/issue30722.go",
            "fixtures/repositories/go/test/fixedbugs/issue32133.go",
            "fixtures/repositories/go/test/fixedbugs/issue4405.go",
            "fixtures/repositories/go/test/fixedbugs/issue9036.go",
            "fixtures/repositories/go/test/slice3err.go",
            // Intentionally invalid syntax tests
            "fixtures/repositories/go/test/syntax/chan.go",
            "fixtures/repositories/go/test/syntax/chan1.go",
            "fixtures/repositories/go/test/syntax/composite.go",
            "fixtures/repositories/go/test/syntax/ddd.go",
            "fixtures/repositories/go/test/syntax/else.go",
            "fixtures/repositories/go/test/syntax/if.go",
            "fixtures/repositories/go/test/syntax/import.go",
            "fixtures/repositories/go/test/syntax/initvar.go",
            "fixtures/repositories/go/test/syntax/semi1.go",
            "fixtures/repositories/go/test/syntax/semi2.go",
            "fixtures/repositories/go/test/syntax/semi3.go",
            "fixtures/repositories/go/test/syntax/semi4.go",
            "fixtures/repositories/go/test/syntax/semi5.go",
            "fixtures/repositories/go/test/syntax/semi6.go",
            "fixtures/repositories/go/test/syntax/semi7.go",
            "fixtures/repositories/go/test/syntax/topexpr.go",
            "fixtures/repositories/go/test/syntax/typesw.go",
            "fixtures/repositories/go/test/syntax/vareq.go",
            "fixtures/repositories/go/test/syntax/vareq1.go",
            "fixtures/repositories/go/test/ddd1.go",
            // Files using //line directives
            "fixtures/repositories/go/test/dwarf/linedirectives.go",
            "fixtures/repositories/go/test/dwarf/dwarf.dir/z1.go",
            "fixtures/repositories/go/test/dwarf/dwarf.dir/z2.go",
            "fixtures/repositories/go/test/dwarf/dwarf.dir/z3.go",
            "fixtures/repositories/go/test/dwarf/dwarf.dir/z4.go",
            "fixtures/repositories/go/test/dwarf/dwarf.dir/z5.go",
            "fixtures/repositories/go/test/dwarf/dwarf.dir/z6.go",
            "fixtures/repositories/go/test/dwarf/dwarf.dir/z7.go",
            "fixtures/repositories/go/test/dwarf/dwarf.dir/z8.go",
            "fixtures/repositories/go/test/dwarf/dwarf.dir/z9.go",
            "fixtures/repositories/go/test/dwarf/dwarf.dir/z10.go",
            "fixtures/repositories/go/test/dwarf/dwarf.dir/z11.go",
            "fixtures/repositories/go/test/dwarf/dwarf.dir/z12.go",
            "fixtures/repositories/go/test/dwarf/dwarf.dir/z13.go",
            "fixtures/repositories/go/test/dwarf/dwarf.dir/z14.go",
            "fixtures/repositories/go/test/dwarf/dwarf.dir/z15.go",
            "fixtures/repositories/go/test/dwarf/dwarf.dir/z16.go",
            "fixtures/repositories/go/test/dwarf/dwarf.dir/z17.go",
            "fixtures/repositories/go/test/dwarf/dwarf.dir/z18.go",
            "fixtures/repositories/go/test/dwarf/dwarf.dir/z19.go",
            "fixtures/repositories/go/test/dwarf/dwarf.dir/z20.go",
            // Parser testdata
            "fixtures/repositories/go/src/go/parser/testdata/issue42951/not_a_file.go",
            "fixtures/repositories/go/src/go/parser/testdata/issue42951/not_a_file.go/invalid.go",
            // Invalid characters
            "fixtures/repositories/go/src/cmd/compile/internal/types2/testdata/local/issue68183.go",
            "fixtures/repositories/go/src/internal/types/testdata/local/issue68183.go",
            // Type checker test files
            "fixtures/repositories/go/src/internal/types/testdata/fixedbugs/issue39634.go",
            "fixtures/repositories/go/src/cmd/compile/internal/types2/testdata/fixedbugs/issue39634.go",
            "fixtures/repositories/go/src/internal/types/testdata/examples/types.go",
            "fixtures/repositories/go/src/cmd/compile/internal/types2/testdata/examples/types.go",
            "fixtures/repositories/go/test/func3.go",
            "fixtures/repositories/go/test/import5.go",
            // Cgo test file
            "fixtures/repositories/go/src/cmd/cgo/internal/testerrors/testdata/err5.go",
            // Type checker tests
            "fixtures/repositories/go/src/internal/types/testdata/check/stmt0.go",
            "fixtures/repositories/go/src/internal/types/testdata/check/typeinst0.go",
            "fixtures/repositories/go/src/internal/types/testdata/check/typeparams.go",
            "fixtures/repositories/go/src/internal/types/testdata/check/vardecl.go",
            "fixtures/repositories/go/src/internal/types/testdata/examples/functions.go",
            "fixtures/repositories/go/test/typeparam/issue50317.go",
            "fixtures/repositories/go/src/internal/types/testdata/fixedbugs/issue43087.go",
        ] {
            set.insert(file);
        }
        set
