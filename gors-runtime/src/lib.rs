...
pub use interfaces::{
    ...
    go_interface_box_go_slice_go_string, go_interface_box_go_slice_i64, go_interface_box_go_string,
    ...
    go_interface_unbox_go_slice_i64, go_interface_unbox_go_string, go_interface_unbox_i64,
