use gors_runtime::{
    GoChannelI64, GoInt, GoMapStringI64, GoPointerI64, GoPointerStructI64, GoSliceI64, GoSliceU8,
    ...
    go_pointer_struct_i64_set, go_slice_i64_append, go_slice_i64_cap, go_slice_i64_clear,
