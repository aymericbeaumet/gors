use gors_runtime::{
    ...
    go_map_i64_go_string_is_nil, go_map_i64_go_string_len, go_map_i64_go_string_make,
    go_map_i64_go_string_nil, go_map_i64_go_string_range_keys, go_map_i64_go_string_set,
    ...
    go_map_string_i64_len, go_map_string_i64_make, go_map_string_i64_nil,
...
fn implementation_surface(operation: RuntimeOp) -> RuntimeSurface {
    match operation {
        ...
        RuntimeOp::GoInterfaceBoxF32 => runtime_surface!(
            go_interface_box_f32,
            fn(GoString, f64) -> GoInterface,
            [RuntimeType::GoString, RuntimeType::F64] -> RuntimeType::GoInterface
        ),
        RuntimeOp::GoInterfaceUnboxF32 => runtime_surface!(
