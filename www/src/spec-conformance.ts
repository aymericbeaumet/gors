...
// Run `npm run generate:conformance-report` from www/ after editing gors/tests/fixtures/go_spec/spec.json.

export type SpecConformanceStatus = "passing" | "unsupported";
...
export interface SpecConformanceCategory {
	...
	readonly unsupportedTestCount: number;
...
export const specConformanceCategories: readonly SpecConformanceCategory[] = [
	...
	},
	{
		...
		"tests": [
			...
			{
				"id": "types-pointer-receiver-interface-methods",
				"section": "Method sets",
				"title": "Pointer receiver methods satisfy interfaces through pointer values",
				"status": "passing",
				"fixtures": [
					"types"
				],
